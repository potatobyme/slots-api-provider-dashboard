  ...
  const SearchInput = ({ className = "" }) => (
    <div className={`relative ${className}`}>
      <input
        ...
        className="w-full pl-10 pr-4 py-2 rounded-lg border border-gray-200 focus:outline-none focus:ring-2 focus:ring-[#18B69B] focus:border-transparent transition-all"
      />
